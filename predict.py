...
def train_and_tune_xgb_models(xgb_model_manual, grid_search, bayes_search, train_features, train_targets, tuning_flag):
    xgb_models = {}
...
def prediction_pipline():
    ...
    manual_model, grid_model, bayes_model = init_XGBoost_tuning()

    # Train and Tune XGBoost Model for Each Target Trait
    xgb_models = train_and_tune_xgb_models(manual_model, grid_model, bayes_model, train_combined_features, train_targets, tuning_flag)
